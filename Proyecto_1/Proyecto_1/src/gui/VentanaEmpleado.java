...
public class VentanaEmpleado extends JFrame{
	...
	public VentanaEmpleado(Hotel hotel) {
		...
		JScrollPane Facturas_1_1 = new JScrollPane();
		Facturas_1_1.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
		Facturas_1_1.setToolTipText("sdfsdf");
		Facturas_1_1.setBounds(24, 402, 383, 58);
		panelAdicionServicio.add(Facturas_1_1);
		...
		comboBox.setBounds(10, 86, 358, 59);
		...
		btnSeleccionar_1_1.setBounds(251, 52, 117, 23);
		panel_1.add(btnSeleccionar_1_1);
		
		JLabel lblNewLabel_3_1_1 = new JLabel("Agregar plato seleccionado");
		lblNewLabel_3_1_1.setForeground(SystemColor.textHighlight);
		lblNewLabel_3_1_1.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 11));
		lblNewLabel_3_1_1.setBounds(224, 37, 155, 14);
		panel_1.add(lblNewLabel_3_1_1);
		
		JFormattedTextField formattedTextField_1_1_2_1 = new JFormattedTextField();
		formattedTextField_1_1_2_1.setEditable(false);
		formattedTextField_1_1_2_1.setBounds(62, 37, 93, 20);
		panel_1.add(formattedTextField_1_1_2_1);
