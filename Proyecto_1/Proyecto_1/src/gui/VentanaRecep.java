...
public class VentanaRecep extends JFrame{
	public VentanaRecep() {
		...
		lblNumeroDeNios_1.setBounds(132, 79, 43, 18);
		...
		textField_19.setBounds(171, 78, 38, 20);
		...
		lblFecha_1.setBounds(313, 11, 63, 18);
		panelAgregar_1_1.add(lblFecha_1);
		
		textField_22 = new JTextField();
		textField_22.setColumns(10);
		textField_22.setCaretColor(SystemColor.activeCaption);
		textField_22.setBorder(new LineBorder(SystemColor.textHighlight, 1, true));
		textField_22.setBackground(Color.WHITE);
		textField_22.setBounds(386, 7, 63, 20);
		...
		lblHabitacionesDisponibles.setBounds(323, 40, 156, 18);
		...
		textField_24.setCaretColor(SystemColor.activeCaption);
		textField_24.setBorder(new LineBorder(SystemColor.textHighlight, 1, true));
		textField_24.setBackground(Color.WHITE);
		textField_24.setBounds(208, 128, 88, 20);
		panelAgregar_1_1.add(textField_24);
