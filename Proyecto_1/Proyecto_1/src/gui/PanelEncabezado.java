...
public class PanelEncabezado extends JPanel {
	...
	{		
		...
		lbAdministrador = new JLabel("Administrador");
		lbAdministrador.setPreferredSize(new Dimension(80, 40));
		lbAdministrador.setForeground(Color.WHITE);
		lbAdministrador.setBackground(Azul);
