...
public class PanelOpciones extends JPanel {
	...
	public PanelOpciones(VentanaAdmi ventanaAdmi) 
	{
        ...
        btUsuario.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {             	
            	ventanaAdmi.cambiarPanel(ventanaAdmi.getPanelUsuarios());
            }
        });
		...
		btTarifas.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {             	
            	ventanaAdmi.cambiarPanel(ventanaAdmi.getPanelTarifas());
            }
        });
        ...
        btHabitaciones.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {             	
            	ventanaAdmi.cambiarPanel(ventanaAdmi.getPanelHabitaciones());
            }
        });
        ...
        btInventarios.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {             	
            	ventanaAdmi.cambiarPanel(ventanaAdmi.getPanelInventarios());
            }
        });
